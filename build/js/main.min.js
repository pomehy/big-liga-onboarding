...
Object(_modules_preloader__WEBPACK_IMPORTED_MODULE_3__["preloader"])(); // Modules
// ---------------------------------
...
/* harmony import */ var _page_controler_animation_controller__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../page-controler/animation-controller */ "./js/page-controler/animation-controller.js");
...
var preloader = function preloader() {
  ...
  var preloaderNode = document.querySelector('.js-preloader');
  var preloaderActionText = document.querySelector('.preloader__action-text');
    ...
    _createClass(Preloader, [{
      ...
      value: function load() {
        ...
        var hidePreloader = function hidePreloader() {
          _this.el.classList.add('is-hidden');
        };

        var closePreloader = function closePreloader() {
          document.body.classList.remove('scroll-lock');

          _this.el.classList.add('is-fade');

          setTimeout(hidePreloader, 10);
          Object(_page_controler_animation_controller__WEBPACK_IMPORTED_MODULE_0__["initialAnimation"])();
        };

        preloaderNode.addEventListener('click', function () {
          if (preloaderNode.classList.contains('is-ready')) {
            closePreloader();
          }
        });
        document.addEventListener('keydown', function (evt) {
          var isEnterKey = evt.code;
...
/***/ "./js/page-controler/animation-controller.js":
/*!***************************************************!*\
  !*** ./js/page-controler/animation-controller.js ***!
  \***************************************************/
/*! exports provided: initialAnimation */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initialAnimation", function() { return initialAnimation; });
var intro = document.querySelector('.intro');
var introAnimateEl = document.querySelector('.intro__animate');
var pageHeader = document.querySelector('.header');
var emblemLiga = document.querySelector('.emblem');
...
var controlClassIntro = function controlClassIntro() {
